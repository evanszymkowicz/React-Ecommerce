...
class CartPopup extends Component {
  ...
  render() {
    return (<section id="cart-popup" className={this.props.globalState.popupCartOpen == true
        ? 'active'
        : ''}>
...
export default connect(mapStateToProps, {closingCart})(CartPopup);
